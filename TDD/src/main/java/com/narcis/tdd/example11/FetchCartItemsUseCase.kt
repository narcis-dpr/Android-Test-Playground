...
import com.narcis.tdd.example11.networking.GetCartItemsHttpEndpoint.FailReason
import com.narcis.tdd.example11.networking.GetCartItemsHttpEndpoint.FailReason.*
import com.narcis.tdd.example9.AddToCartUseCaseSync
...
class FetchCartItemsUseCase(private val mGetCartItemsHttpEndpoint: GetCartItemsHttpEndpoint) {
    ...
    fun fetchCartItemsAndNotify(limit: Int) {
        mGetCartItemsHttpEndpoint.getCartItems(limit, object : GetCartItemsHttpEndpoint,
            GetCartItemsHttpEndpoint.Callback {
            override fun onGetCartItemsSucceeded(cartItems: MutableList<CartItemSchema>?) {
            ...
            override fun getCartItems(limit: Int, callback: GetCartItemsHttpEndpoint.Callback?) {
